...
const coloresTema = (esModoOscuro) => ({
  ...
  accentGradient: COLOR_BOTON_AZUL,
})
  ...
  return (
    <div style={{ minHeight: '100vh', background: c.pageBg, display: 'flex', flexDirection: 'column', overflowX: 'hidden' }}>
      ...
      <div style={{ paddingTop: '68px', flex: 1 }}>
        ...
        {sucursalActiva && (
          <div ref={resultadosRef} style={{ maxWidth: '1280px', margin: '40px auto 80px', padding: '0 24px' }}>
            <div style={{
              background: c.panelBg,
              borderRadius: '24px',
              padding: '32px',
