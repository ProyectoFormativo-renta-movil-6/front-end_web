        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px', flexShrink: 0 }}>
            {(caracteristicas || []).map((item, i) => {
              const Icono = item.icono || item.icon || FaCog
              return (
                <div
                  key={i}
                  style={{
          ...
          {tarifas && (
            <div
              style={{
                background: c.tariffBg || '#f2fff4',
                borderRadius: '8px',
                padding: '8px 10px',
                border: `1px solid ${c.tariffBorder || '#bfe8c7'}`,
                flexShrink: 0,
              }}
            >
              <div
          ...
          {seguros.length > 0 && (
            <div
              style={{
                background: c.insuranceBg || '#f5f9ff',
                borderRadius: '8px',
                padding: '8px 10px',
                border: `1px solid ${c.insuranceBorder || '#d8e6ff'}`,
                flexShrink: 0,
              }}
            >
              <div
